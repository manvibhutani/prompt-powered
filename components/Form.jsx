...
handleSubmit,
  ...
  return (
   <section className='w-full max-w-full flex-start flex-col'>
    ...
    {type} and share amazing prompts with the world, and let your imagination run wwild with any AI- powered platform.
    </p>
    <form
    onSubmit={handleSubmit}
    className='mt-10 w-full max-w-2xl flwx flwx-xol gap-7 glassmorphism'>
        <label>
